        ...
        <div className="space-y-4">
          {POSTS.map((p, i) => (
            <Reveal key={p.title} delay={i * 80}>
              <div className="rounded-2xl border border-mist bg-white p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
        ...
        <Reveal>
          <div className="relative rounded-3xl bg-paper-2 border border-mist overflow-hidden px-6 py-16 text-center">
            ...
            <div className="relative">
              <div className="w-14 h-14 rounded-full bg-electric-dim flex items-center justify-center mx-auto mb-6">
